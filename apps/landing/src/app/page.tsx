import {
  CONTACTO,
  DISCIPLINAS,
  TARIFAS_INDIVIDUALES,
  TARIFAS_PLANAS,
  WHATSAPP_CTA,
} from "../lib/datos-gimnasio";
    ...
    <>
      <header className="cabecera">
        <div className="cabecera-marca">
          <img src="/logo.png" alt="Fighters Gym" className="cabecera-logo" />
        </div>
      ...
      <section className="hero">
        <div className="hero-contenido">
          <span className="hero-etiqueta">
            Club Federado · Almàssera, Valencia
          </span>
          <h1 className="display">
            Aquí se suda{" "}
            <span style={{ color: "var(--accent)" }}>en familia</span>
          </h1>
          <p>
            Boxeo, kickboxing, muay thai, MMA, jiu-jitsu, grappling y krav maga.
            Da igual si vienes a competir o a soltar el día — aquí entrenas con
            gente de verdad, desde el primer asalto.
          </p>
      ...
      <section id="disciplinas" className="seccion seccion--alt">
        <div className="contenedor">
          <div className="seccion-cabecera">
            ...
            <p>
              Grupos reducidos, técnica de verdad y progresión adaptada a cada
              alumno.
            </p>
          </div>
          <div className="disciplinas-lista">
            {DISCIPLINAS.map((disciplina, indice) => (
              <div className="disciplina-panel" key={disciplina.nombre}>
                <span className="disciplina-panel-indice display">
          ...
          <div className="competicion-nota">
            <strong style={{ color: "var(--text)" }}>Competición</strong> — club
            federado, con grupo de preparación para quien quiere subirse al
            cuadrilátero o al tatami de verdad.
          </div>
        </div>
      </section>
      ...
      <section id="horarios" className="seccion seccion--alt">
        <div className="contenedor">
          <div className="seccion-cabecera">
            ...
            <p>
              Sábado: horario de competición variable, consulta disponibilidad.
              Domingo: cerrado.
            </p>
          </div>
      ...
      <section id="tarifas" className="seccion">
        <div className="contenedor">
          <div className="seccion-cabecera">
            ...
            <p>
              Todas las cuotas incluyen acceso a sala libre. Matrícula: 25€
              (pago único).
            </p>
          </div>
          <div className="tarifas-grid">
              ...
              {TARIFAS_INDIVIDUALES.map((tarifa) => (
                <div className="tarifa-fila" key={tarifa.nombre}>
                  ...
                  <span className="tarifa-precio">
                    {tarifa.precio}€
                    <span className="tarifa-precio-unidad">/mes</span>
                  </span>
                </div>
              ))}
            </div>
            <div>
              ...
              <p className="tarifas-extra">
                Entrenamiento personal, planes de nutrición y seguimiento
                también disponibles — pregunta en recepción o por WhatsApp.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="contenedor">
          <div className="contacto-grid">
            <div className="contacto-info">
              ...
              <div className="contacto-linea">
                <IconoTelefono />
                <a href={`tel:+${CONTACTO.telefonoInternacional}`}>
                  {CONTACTO.telefono}
                </a>
              </div>
              <div className="contacto-linea">
      ...
      <footer className="pie">
        <img src="/logo.png" alt="Fighters Gym" className="pie-logo" />
...
function ClasesDeFranja({ clases }: { clases: ClaseFranja[] }) {
  if (clases.length === 0) {
    return (
      <span className="horario-clase horario-clase--libre">Sala libre</span>
    );
  }
  return (
    <>
      {clases.map((clase) => (
        <span key={clase.nombre} style={{ display: "block" }}>
          ...
          {clase.sparring === true && (
            <span className="horario-sparring"> · sparring</span>
          )}
        </span>
      ))}
    </>
